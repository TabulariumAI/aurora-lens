import type { ViewerState, ViewerStatus, SelectionColor, PageSizeConfig } from "@tabularium/aurora-lens";
...
export type { ViewerState, ViewerStatus, SelectionColor, PageSizeConfig };
